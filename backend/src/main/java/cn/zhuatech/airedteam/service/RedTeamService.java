...
@Service public class RedTeamService{
 private final CampaignAuditRepository repository;public RedTeamService(CampaignAuditRepository r){repository=r;}
 ...
 public enum Severity{LOW,MEDIUM,HIGH,CRITICAL}public enum Decision{PASS,REMEDIATE,BLOCK}
}
